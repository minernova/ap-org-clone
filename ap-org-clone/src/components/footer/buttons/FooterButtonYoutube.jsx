...
export default function FooterButtonYoutube() {
  return (
    <>
    <button class=" flex ms-0 p-0 items-center  rounded-lg  group transition-all duration-300">
            <svg
              class="rounded-md p-0 transition-all duration-300 group-hover:scale-110 "
